patches-own [
  ...
  odoreNido            ;; pi˘ Ë alto, pi˘ si Ë vicini al nido
]
...
to setup-nido  ;; patch procedure
  ...
  ;; spande l'odore del nido; pi˘ Ë alto, pi˘ si Ë vicini al nido
...
to-report sense-smell-at-angle [angle]     ;;turtle function
  let p patch-right-and-ahead angle 1
  report [feromone] of p
end

to-report sense-nest-smell-at-angle [angle]
  let p patch-right-and-ahead angle 1
...
to find-food ;; turtle procedure
  let surrounding-smell map [a -> sense-smell-at-angle a] [0 45 -45]
  rt position (max surrounding-smell) surrounding-smell
  fd 1
...
to stigmergy  ;; observer procedure
